(function(g) {
    ...
    var ZQa = function(a, b) {
            ...
            for (var d = 0, e = 1, f = 0, h = 0; 8 > h; h++) {
                f = g.or(a, c);
                var l = (g.or(a, c + 1E-6) - f) / 1E-6;
                if (1E-6 > Math.abs(f - b)) return c;
                if (1E-6 > Math.abs(l)) break;
                else f < b ? d = c : e = c, c -= (f - b) / l
            }
            for (h = 0; 1E-6 < Math.abs(f - b) && 8 > h; h++) f < b ? (d = c, c = (c + e) / 2) : (e = c, c = (c + d) / 2), f = g.or(a, c);
            return c
        },
        x5 = function() {
            return {
        ...
        y5 = function(a) {
            g.I.call(this);
            this.callback = a;
            this.B = new g.nr(0, 0, .4, 0, .2, 1, 1, 1);
        ...
        z5 = function(a) {
            ...
            this.previous.Qa("click", this.TP, this);
            g.J(this, this.S);
            for (var c = {
                    Oq: 0
                }; 16 > c.Oq; c = {
                ...
                g.Ql(e, "transitionDelay", c.Oq / 20 + "s");
                this.C.T(e, "click", function(f) {
                    return function(h) {
                        var l = b.suggestionData[f.Oq],
                            m = l.sessionData;
                        g.qN(h, b.api, b.K, m || void 0) && b.api.Kj(l.videoId, m, l.playlistId)
                    }
                }(c));
                this.B.push(d)
            }
            ...
            this.next.Qa("click", this.SP, this);
        ...
        $Qa = function(a) {
            for (var b = 0; b < a.suggestionData.length; b++) {
                var c = a.suggestionData[b],
                    ...
                    f = c.yk();
                g.UE(a.api.V()) && (f = g.si(f, g.pM("emb_rel_err")));
                d.element.style.display = "";
                var h = d.Fa("ytp-suggestion-title");
                g.lr.test(c.title) ? h.dir = "rtl" : g.yMa.test(c.title) && (h.dir = "ltr");
                h = d.Fa("ytp-suggestion-author");
                g.lr.test(e) ? h.dir = "rtl" : g.yMa.test(e) && (h.dir = "ltr");
                h = c.isLivePlayback ? "Live" : c.lengthSeconds ? g.FL(c.lengthSeconds) : "";
                d.update({
                    views_or_author: e,
                    duration: h,
                    link: f,
        ...
        bRa = function(a, b) {
            var c, d, e, f, h;
            b.reason && (C5(b.reason) ? h = g.qA(b.reason) : h = g.wN(g.pA(b.reason)), a.jd(h, "content"));
            var l;
            b.subreason && (C5(b.subreason) ? l = g.qA(b.subreason) : l = g.wN(g.pA(b.subreason)), a.jd(l, "subreason"));
            if (b.proceedButton && b.proceedButton.buttonRenderer && (a = a.Fa("ytp-error-content-wrap-subreason"), h = b.proceedButton.buttonRenderer, b = g.Fg("A"), h.text && h.text.simpleText)) {
                l = h.text.simpleText;
                b.textContent = l;
                a: {
                ...
                l || (l = null === (d = null ===
                    (c = null === h || void 0 === h ? void 0 : h.navigationEndpoint) || void 0 === c ? void 0 : c.urlEndpoint) || void 0 === d ? void 0 : d.url, h = null === (f = null === (e = null === h || void 0 === h ? void 0 : h.navigationEndpoint) || void 0 === e ? void 0 : e.urlEndpoint) || void 0 === f ? void 0 : f.target, l && b.setAttribute("href", l), h && b.setAttribute("target", h), h = g.Fg("DIV"), h.appendChild(b), a.appendChild(h))
            }
        },
        C5 = function(a) {
            if (a.runs)
        ...
        D5 = function(a, b) {
            ...
            this.api = a;
            this.u = b;
            this.Ra("target", a.V().J);
            this.api.Rb(this.element, this, 96714);
            this.T(this.api, "presentingplayerstatechange", this.Nh);
        ...
        G5 = function(a, b) {
            ...
            this.api = a;
            this.J = b;
            this.i = new g.rD(this);
            this.C = new g.rL(this, 1E3, !1, 100);
            this.B = [];
            this.suggestionData = [];
            this.containerWidth = 0;
            this.D = !1;
            ...
            g.J(this, this.previous);
            this.previous.Da(this.element);
            this.previous.Qa("click", this.VP, this);
            g.J(this, this.S);
            for (a = {
                    Pq: 0
                }; 16 > a.Pq; a = {
                ...
                d.Da(this.suggestions.element);
                var e = d.Fa("ytp-suggestion-link");
                g.Ql(e, "transitionDelay", a.Pq / 20 + "s");
                this.i.T(e, "click", function(f) {
                    return function(h) {
                        var l = f.Pq;
                        if (1E3 > (0, g.Q)() - c.ma) g.Fu(h), document.activeElement.blur();
                        else {
                            l = c.suggestionData[l];
                            var m = l.sessionData;
                            g.qN(h, c.api, c.K, m || void 0) && c.api.Kj(l.videoId, m, l.playlistId)
                        }
                    }
                }(a));
                this.B.push(d)
            ...
            g.J(this, this.next);
            this.next.Da(this.element);
            this.next.Qa("click", this.UP, this);
            b = new g.V({
                G: "button",
            ...
            g.J(this, b);
            b.Da(this.element);
            b.Qa("click", this.TT, this);
            g.J(this, this.expandButton);
            this.expandButton.Da(this.element);
            this.expandButton.Qa("click", this.UT,
                this);
            this.i.T(this.api, "appresize", this.xb);
            this.i.T(this.api, "fullscreentoggled", this.gm);
            this.i.T(this.api, "presentingplayerstatechange", this.Lc);
        ...
        cRa = function(a) {
            for (var b = 0; b < a.suggestionData.length; b++) {
                ...
                d.element.style.display = "";
                g.xMa.test(c.title) && (d.Fa("ytp-suggestion-title").dir = "rtl");
                g.xMa.test(e) && (d.Fa("ytp-suggestion-author").dir = "rtl");
                var f = c.isLivePlayback ? "Live" : c.lengthSeconds ? g.FL(c.lengthSeconds) : "";
                var h = c.yk();
                g.UE(a.api.V()) && (h = g.si(h, g.pM("emb_rel_pause")));
                d.update({
                    author_and_views: e,
                    duration: f,
                    link: h,
                    ...
                    aria_label: c.yl || null,
                    is_live: c.isLivePlayback,
                    aria_hidden: !(!c.yl || a.api.V().N("embeds_rv_aria_hidden_killswitch")),
                    blink_rendering_hack: g.Vi || g.SE ? "will-change: opacity" : void 0
                });
                d = d.Fa("ytp-suggestion-image");
                c = c.He();
        ...
        I5 = function(a) {
            ...
            g.V.call(this, {
                ...
                W: {
                    target: b.J,
                    href: "{{url}}",
                    "aria-label": g.lI("Watch on $WEBSITE", {
                        WEBSITE: g.oF(b)
                    }),
            ...
            this.T(a, "videodatachange", this.PG);
    ...
    y5.prototype.next = function() {
        ...
        var b = this.B;
        a = ZQa(b, a / this.duration);
        if (0 == a) b = b.K;
        else if (1 == a) b = b.S;
        else {
            var c = g.Yf(b.K, b.D, a),
                d = g.Yf(b.D, b.J, a);
            b = g.Yf(b.J, b.S, a);
            c = g.Yf(c, d, a);
            d = g.Yf(d, b, a);
    ...
    g.k.resize = function(a, b) {
        ...
        if (150 >= Math.min(a.width, a.height) || 0 === h || !c.zb) this.hide();
            ...
            b && m + 100 > b && 50 < l && (m = Math.max(b, 50 / d), l = Math.ceil(a / (d * (m - 100) + this.i)), l = a / l - this.i,
                m = Math.floor(l / d));
            50 > l || g.EM(this.api) ? this.hide() : this.show();
            for (b = 0; b < h; b++) {
                d = this.B[b];
    ...
    g.k.onVideoDataChange = function() {
        var a = this.api.getVideoData(),
            b = this.api.V();
        this.K = a.D ? !1 : b.i;
        a.suggestions ? this.suggestionData = g.Jo(a.suggestions, function(c) {
            return c && !c.playlistId
        }) : this.suggestionData.length = 0;
        $Qa(this);
        a.D ? this.title.update({
            title: g.lI("More videos from $DNI_RELATED_CHANNEL", {
    ...
    g.k.scrollTo = function(a) {
        a = g.Wf(a, this.containerWidth - this.suggestionData.length * (this.tileWidth + this.i), 0);
    ...
    B5.prototype.show = function() {
        g.vN.prototype.show.call(this);
        aRa(this, this.api.bb().getPlayerSize())
    };
    B5.prototype.resize = function(a) {
        g.vN.prototype.resize.call(this, a);
        aRa(this, a);
        g.O(this.element, "related-on-error-overlay-visible", !this.i.isHidden())
    };
    B5.prototype.u = function(a) {
        g.vN.prototype.u.call(this, a);
        var b = this.api.getVideoData();
        if (b.PC || b.playerErrorMessageRenderer)(a = b.PC) ? bRa(this, a) : b.playerErrorMessageRenderer && bRa(this, b.playerErrorMessageRenderer);
        else {
            var c;
            a.oi && (b.lq ? C5(b.lq) ? c = g.qA(b.lq) : c = g.wN(g.pA(b.lq)) : c = g.wN(a.oi), this.jd(c, "subreason"))
        }
    };
    g.w(D5, g.V);
    D5.prototype.Nh = function() {
        this.api.yb().isCued() || (this.hide(), this.api.ib(this.element, !1))
    };
    D5.prototype.i = function() {
        var a = this.api.getVideoData(),
            ...
            f = this.u.tf();
        b = g.eF(b);
        d || f || c || e || b || !a.videoId ? (this.hide(), this.api.ib(this.element, !1)) : (a = g.si(this.api.getVideoUrl(), g.pM("emb_imp_woyt")), this.Ra("url", a), this.show())
    };
    D5.prototype.onClick = function(a) {
        var b = g.si(this.api.getVideoUrl(), g.pM("emb_imp_woyt"));
        g.rN(b, this.api, a);
        this.api.Fb(this.element)
    };
    D5.prototype.show = function() {
        this.api.yb().isCued() && (g.V.prototype.show.call(this), this.api.Pv(this.element) && this.api.ib(this.element, !0))
    };
    g.w(E5, g.V);
    E5.prototype.u = function() {
        var a = this.api.yb(),
            b = this.api.getVideoData();
        this.api.V().N("embeds_enable_muted_autoplay") && b.mutedAutoplay && (g.T(a, 2) && !this.Ab ? (this.show(), this.i.show(), a = this.api.getVideoData(), this.Ra("text", a.jH), g.O(this.element, "ytp-muted-autoplay-show-end-panel", !0), this.api.ib(this.element, this.Ab), this.api.Oa("onMutedAutoplayEnds")) : this.hide())
    };
    ...
    F5.prototype.i = function() {
        var a = this.api.yb(),
            b = this.api.getVideoData();
        this.api.V().N("embeds_enable_muted_autoplay") && b.mutedAutoplay && !g.T(a, 2) ? this.Ab || (g.V.prototype.show.call(this), this.B.start(), this.api.ib(this.element, this.Ab)) : this.hide()
    };
    ...
    g.k = G5.prototype;
    g.k.hide = function() {
        g.Rq(this.api.getRootNode(), "ytp-expand-pause-overlay");
        g.V.prototype.hide.call(this)
    };
    g.k.TT = function() {
        this.D = !0;
    ...
    g.k.Lc = function(a) {
        if (!(g.T(a.state, 1) || g.T(a.state, 16) || g.T(a.state, 32))) {
            ...
            !g.T(a.state, 4) || g.T(a.state, 2) || b ? this.C.hide() : this.suggestionData.length && (this.D || (g.N(this.api.getRootNode(), "ytp-expand-pause-overlay"), H5(this)), this.C.show(), this.ma = (0, g.Q)())
        }
    };
    g.k.xb = function(a) {
        var b = 16 / 9,
    ...
    g.k.onVideoDataChange = function() {
        var a = this.api.V(),
            b = this.api.getVideoData();
        this.K = b.D ? !1 : a.i;
        b.suggestions ? this.suggestionData = g.Jo(b.suggestions, function(c) {
            return c && !c.playlistId
        }) : this.suggestionData.length = 0;
        cRa(this);
    ...
    g.k.scrollTo = function(a) {
        a = g.Wf(a, this.containerWidth - this.suggestionData.length * (this.tileWidth + 8), 0);
        this.S.start(this.u, a, 1E3);
        this.u = a;
        H5(this)
    };
    ...
    g.k.PG = function() {
        var a = this.api.getVideoData(),
            ...
            c = this.api.V();
        a = (a.mutedAutoplay || c.Db && !g.T(this.state, 2)) && !(b && c.pfpChazalUi);
        g.IK(this, a);
    ...
    g.k.onVideoDataChange = function() {
        if (this.api.getVideoData().videoId) {
            ...
            this.Ra("url", a);
            this.i || (this.i = this.Qa("click", this.onClick))
        } else this.i && (this.Ra("url", null), this.jc(this.i), this.i = null)
    };
    g.k.onClick = function(a) {
        var b = this.api.getVideoUrl(!g.GL(a), !1, !0, !0);
        g.rN(b, this.api, a);
        this.api.Fb(this.element)
    };
    g.k.xb = function(a) {
    ...
    g.k.create = function() {
        ...
        d && g.PA("cpn", d);
        b.zb && (this.D = new G5(this.I, c), g.J(this, this.D), g.HM(this.I, this.D.element, 4));
        b.N("embeds_enable_muted_autoplay") && (this.i = new F5(this.I), g.J(this, this.i), g.HM(this.I, this.i.element, 4), this.C = new E5(this.I), g.J(this, this.C), g.HM(this.I, this.C.element, 4));
        if (b.Db || this.i) this.watermark = new I5(this.I), g.J(this, this.watermark), g.HM(this.I, this.watermark.element,
            7);
        b.N("embeds_impression_link") && (this.B = new D5(this.I, c), g.J(this, this.B), g.HM(this.I, this.B.element, 7));
        this.u.T(this.I, "appresize", this.xb);
        this.u.T(this.I, "presentingplayerstatechange", this.Nh);
        this.u.T(this.I, "videodatachange", this.GX);
        this.u.T(this.I, "onMutedAutoplayStarts", this.onMutedAutoplayStarts);
        this.Ub(this.I.yb());
        this.player.Ld("embed")
    };
    g.k.xb = function() {
        var a = this.I.bb().getPlayerSize();
        this.ye && this.ye.resize(a)
    };
    g.k.Nh = function(a) {
        this.Ub(a.state)
    };
    g.k.Ub = function(a) {
        g.T(a, 128) ? (this.ye || (this.ye = new B5(this.I), g.J(this, this.ye), g.HM(this.I, this.ye.element, 4)), this.ye.u(a.getData()), this.ye.show(), g.N(this.I.getRootNode(), "ytp-embed-error")) : this.ye && (this.ye.dispose(), this.ye = null, g.Rq(this.I.getRootNode(), "ytp-embed-error"))
    };
    ...
    g.k.GX = function() {
        ...
        this.watermark && this.i && !a.mutedAutoplay && g.Lg(this.i.element, this.watermark.element) && g.HM(this.I, this.watermark.element, 7)
    };
    g.TM("embed", J5);
})(_yt_player);