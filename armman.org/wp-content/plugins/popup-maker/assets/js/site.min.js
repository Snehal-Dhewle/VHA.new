...
function(p, s, r) {
    ...
    window.pum_vars = window.pum_vars || {
        ...
        reposition: function(e) {
            ...
            }), o.trigger("pumAfterReposition"), t.addClass("custom-position").position(s).trigger("popmakeAfterReposition"), "center" === i && t[0].offsetTop < 0 && t.css({
            ...
            if (r.conditions.length)
                for (o = 0; r.conditions.length > o; o++) {
                    for (n = r.conditions[o], e = !1, t = 0; n.length > t && ((!(i = p.extend({}, {
                            not_operand: !1
                        }, n[t])).not_operand && s.popmake("checkCondition", i) || i.not_operand && !s.popmake("checkCondition", i)) && (e = !0), p(this).trigger("pumCheckingCondition", [e, i]), !e); t++);
                    e || (a = !1)
                }
            return a
        },
...
function(c) {
    ...
    c.extend(c.fn.popmake, {
        cookie: (void 0 === d && (d = function() {}), (m.set = m).get = function(e) {
            return m.call(m, e)
        }, m.getJSON = function() {
            return m.apply({
                json: !0
...
function(p) {
    ...
    pum_vars && void 0 !== pum_vars.core_sub_forms_enabled && !pum_vars.core_sub_forms_enabled || (window.PUM = window.PUM || {}, window.PUM.newsletter = window.PUM.newsletter || {}, p.extend(window.PUM.newsletter, {
        ...
        var t = p(e.target),
            ...
            s = PUM.getPopup(t),
            r = PUM.getSetting(s, "id"),
            a = p("form.pum-sub-form", s).index(t) + 1;
    ...
    Array.prototype.indexOf || (Array.prototype.indexOf = function(e) {
        ...
        strtotime: function(e, o) {
            ...
            function u(e) {
                ...
                if ("next" === r || "last" === r) o = r, t = u, void 0 !== (i = c[a]) && (0 === (n = i - l.getDay()) ? n = 7 * t : 0 < n && "last" === o ? n -= 7 : n < 0 && "next" === o && (n += 7), l.setDate(l.getDate() + n));
                else if (!p) return;
                return 1
            }
